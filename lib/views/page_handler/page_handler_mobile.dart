...
import 'package:hopex_progx/views/finances/finances_mobile.dart';
      ...
      bottomNavigationBar: Container(
        ...
        child: Padding(
          ...
          child: CurvedNavigationBar(
            ...
            items: <Widget>[
              Icon(Icons.compare_arrows, size: 22, color: Colors.green,),
              Icon(Icons.autorenew, size: 22, color: Colors.green,),
              Icon(Icons.account_circle, size: 22, color: Colors.green,),
            ],
